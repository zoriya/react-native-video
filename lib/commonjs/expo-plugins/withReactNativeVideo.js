...
var _withAndroidNotificationControls = require("./withAndroidNotificationControls.js");
const withRNVideo = (config, props = {}) => {
  ...
  config = (0, _withAndroidNotificationControls.withAndroidNotificationControls)(config);
  return config;
};
const {
  name,
