...
exports.WebEventEmitter = void 0;
...
class WebEventEmitter {
  ...
  _attachMediaListeners() {
    ...
    cleanups.push(on("error", () => {
      ...
      this._emit("onError", new _VideoError.VideoError(codeMap[err.code] ?? "unknown/unknown", err.message));
    }));
    this._mediaCleanup = () => {
...
exports.WebEventEmitter = WebEventEmitter;
