...
exports.tryParseNativeVideoError = exports.VideoRuntimeError = exports.VideoError = exports.VideoComponentError = void 0;
...
class VideoComponentError extends VideoError {}
exports.VideoComponentError = VideoComponentError;
class VideoRuntimeError extends VideoError {}

/**
 * Check if the message contains code and message
 */
exports.VideoRuntimeError = VideoRuntimeError;
 ...
 * @method
 */
const tryParseNativeVideoError = nativeError => {
...
exports.tryParseNativeVideoError = tryParseNativeVideoError;
